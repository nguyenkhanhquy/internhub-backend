...
public class InternshipReportController {
    ...
    @PostMapping("/submit")
    public ResponseEntity<SuccessResponse<Void>> submitInternshipReport(@Valid @RequestBody SubmitInternshipReportRequest request) {
        internshipReportService.submitInternshipReport(request);
